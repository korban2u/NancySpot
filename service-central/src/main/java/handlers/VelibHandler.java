...
/**
 * VelibHandler mis à jour pour utiliser ServiceCentralImpl
 */
public class VelibHandler implements HttpHandler {

    private static final Logger LOGGER = Logger.getLogger(VelibHandler.class.getName());
    private final Serveur serviceCentral;

    public VelibHandler(Serveur serviceCentral) {
        this.serviceCentral = serviceCentral;
    }

    @Override
    public void handle(HttpExchange exchange) throws IOException {
        LOGGER.info("Requête reçue : " + exchange.getRequestMethod() + " /velib");
        ...
        try {
            ...
            String jsonResponse = serviceCentral.getVelibData();
            ...
            LOGGER.info("Données Vélib envoyées avec succès");
