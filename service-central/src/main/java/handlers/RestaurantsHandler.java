...
/**
 * RestaurantsHandler mis à jour pour utiliser ServiceCentralImpl
 */
public class RestaurantsHandler implements HttpHandler {

    private static final Logger LOGGER = Logger.getLogger(RestaurantsHandler.class.getName());
    ...
    public void handle(HttpExchange exchange) throws IOException {
        LOGGER.info("Requête reçue : " + exchange.getRequestMethod() + " /restaurants");
        ...
        try {
            ...
            String jsonResponse = serviceCentral.getAllRestaurants();
            ...
            LOGGER.info("Restaurants envoyés avec succès");
